# Hyperledger Indy/Aries Agent Demonstration

These instructions describe a demonstration of basic Hyperledger Indy/Aries Agents. The agents provide a web browser interface to show establishing relationships between agents, issuing Verifiable Credentials, and proving claims from Verifiable Credentials.
...
Once you have the demo started, this **[Agent Demo Script](script-aries-browser-lab.md)** guides you through the scenario of Alice using Hyperledger Indy to get her transcripts from Faber College and then using them to apply for a job with Acme Corp.
